...
const LoginPage: React.FC = () => {
  ...
  const from: string = (location.state as { from?: { pathname: string } })?.from?.pathname ?? "/products";
  ...
  const fillDemo = (creds: DemoCredential) =>
    ...
    <div className="min-h-dvh flex items-center justify-center bg-bg px-5 py-10">
      ...
      <div className="w-full max-w-[420px] relative">
        ...
        <div className="mt-4 bg-surface border border-border rounded-2xl px-5 py-4">
          <p className="text-[11px] font-bold uppercase tracking-[1px] text-subtle mb-2.5">
            Demo accounts
          </p>
